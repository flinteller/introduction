...
let currentHR = 147
var is_in_target: Bool = currentHR > targetLowerBound && currentHR < targetUpperBound
var is_below_target: Bool = currentHR < targetLowerBound
var is_above_target: Bool = currentHR > targetUpperBound
if is_in_target == true {
    print("You're right on track")
}
else if is_below_target == true {
    print("You're doing great, but try to push it a bit!")
}
else if is_above_target == true {
